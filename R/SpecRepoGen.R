...
#'
#' convert mzid files produced by IDpicker to tsv file, then generate spectrum report
#'
#'
#' @param protein target protein file generated by IDpicker.
#' @return A spectrum report
#' @export


########## Spectrum Report Generation for IonStar ############

# This script is used after total protein, peptide, spectrum files are generated by IDPicker.

# The aims of this script are:
# Convert individual .mzid files to .tsv files
